...
class CreateNewEnvResourceUsingImport(Command):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument('--envid', '-i', help='Set id to import environment', required=True)
        return parser
    ...
    def take_action(self, parsed_args):
        ...
        try:
            ...
            api_response = api_instance.create_new_env_resource_using_import(parsed_args.envid)
