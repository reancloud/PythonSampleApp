...
class ShareEntity(Command):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument('--entity_id', '-ei', help='Entity id.', required=True)
        ...
        parser.add_argument('--actions', '-p', help='Actions. Allowed values are: [VIEW, EDIT, CREATE, DELETE, DESTROY, DEPLOY, REDEPLOY, IMPORT, EXPORT, SHARE, STOP]. Sample value for this attribute is: [VIEW, EDIT, CREATE, DELETE]', required=True)
    ...
    def take_action(self, parsed_args):
        ...
        if entity is not None:
            multi_share_policy = deploy_sdk_client.MultiSharePolicy(
                ...
                share_policy=ShareEntity.get_share_policy(group, actions),
    ...
    def get_actions(actions):
        ...
        for x in split_actions:
            resource_actions.append(x.strip())
        return resource_actions

    @staticmethod
    def get_share_policy(group, actions):
        """get_share_policy."""
        share_group_permission = deploy_sdk_client.ShareGroupPermission(
            group=group,
            actions=ShareEntity.get_actions(actions)
        )
