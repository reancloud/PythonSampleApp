...
class ImportBlueprint(Command):
    ...
    def take_action(self, parsed_args):
        ...
        try:
            ...
            response_body=swagger_client.ImportConfig(name=parsed_args.name,connection_id=parsed_args.connection_id,description=parsed_args.description,region=parsed_args.region,provider_id=provider_response.id)
           
            blueprint=api_instance.prepare_import_blueprint(file=parsed_args.file)
            
            body = swagger_client.BlueprintImport(environment_imports=jsondata) # BlueprintImport |  (optional)
