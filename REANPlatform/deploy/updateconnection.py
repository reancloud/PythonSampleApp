...
class UpdateConnection(Command):
    ...
    def get_parser(self, prog_name):
        parser = super(UpdateConnection, self).get_parser(prog_name)
    ...
    def take_action(self, parsed_args):
        ...
        try:
            ...
            api_response = api_instance.update_vm_connection(body,callback=callback_function)
