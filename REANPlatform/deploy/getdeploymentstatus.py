...
class Status(Command):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument('--deployment_name', '-dn', default='default', help='Deployment Name. Please provide this attribute, if deployment name is not given value for deployment name will be default.', required=False)
