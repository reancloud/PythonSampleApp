...
class MncConstats(object):      # noqa: D203
    ...
    DEPLOYING = '"DEPLOYING"'
    NOTIFIER_ROLE_NAME = 'IR_rean_mnc_notifier_lambda_lambda_role'
    PROCESSOR_ROLE_NAME = 'IR_rean_mnc_rule_processor_lambda_role' 
    RULE_PROCESSOR_LAMBDA_NAME = 'IR_rean_mnc_rule_processor'
