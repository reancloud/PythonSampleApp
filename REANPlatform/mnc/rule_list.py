...
class RuleList(Command):        # noqa: D203.
    ...
    def take_action(self, parsed_args):
        ...
        try:
            ...
            table = None
            table_only_acc = PrettyTable(['Customer Account Number', 'Rule Name'])
            table_only_name = PrettyTable(['Rule Name', ' Customer Account Number'])
            add_acc = True
            for one_env in all_env:
                ...
                if rule_name and customer_acc:
                    ...
                    if input_json:
                        ...
                        table_only_acc.add_row([customer_acc, rule_name_add])
                        add_acc = False
