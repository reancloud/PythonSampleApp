...
class Configure(Command):   # noqa: D203
    """Configure manage cloud rules. Example: rean-mnc configure --configuration_bucket mnc-cli-config --deploy_group cli-testing --master_provider mnc_master --artifactory_bucket mnc-rule-bucket --master_acc_no 123456789012 --master_connection connection."""
