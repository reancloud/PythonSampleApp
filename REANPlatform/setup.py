...
setup(
    ...
    install_requires=['cliff', 'validators', 'boto3', 'wheel', 'pycryptodome', 'certifi', 'python-jenkins', 'cmd2==0.9.1', 'setuptools>=40.4.1', 'authnz_sdk_client>=2.10.0', 'deploy_sdk_client>=2.10.0', 'test_sdk_client>=2.10.0'],
    namespace_packages=[],
