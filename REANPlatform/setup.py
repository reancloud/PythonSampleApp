...
setup(
    ...
    install_requires=['cliff', 'validators', 'boto3', 'wheel', 'pycryptodome', 'certifi', 'python-jenkins', 'setuptools>=40.4.1', 'authnz_sdk_client', 'deploy_sdk_client', 'test_sdk_client'],
    namespace_packages=[],
