...
class CreateProvider(Command):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument('--provider_file_path', '-pd', help='Json file with applicable key-value pair for provider type. File absolute path', required=True)
    ...
    def take_action(self, parsed_args):
        ...
        try:
            ...
            PlatformUtility.print_output_as_str("{}".format(api_response), parsed_args.output)
