...
class RunCrossBrowserTest(Command):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument('--sample_code_type', '-t',
                            help='Set sample code type as Ruby, Java, HP-UFT, TestComplete ')
        parser.add_argument('--test_suite', '-s', help='Set test suite as Selenium, UFT, TestComplete, NA',
                            required=True)

        parser.add_argument('--chrome', '-C',
                            help='Give the comma separated versions for Chrome to run test on..This option is not mandatory.')
