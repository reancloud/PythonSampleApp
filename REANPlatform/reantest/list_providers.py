                    ...
                    for provider in api_response:
                        table.add_row(
                            [
                                ...
                                provider.name,
                                provider.type,
                                provider.data["access_key"] if "access_key" in provider.data else "",
                                provider.data["secret_key"] if "secret_key" in provider.data else "",
                                provider.data["region"] if "region" in provider.data else "",
